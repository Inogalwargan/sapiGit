                            ...
                            <form action="#">
                                <div class="form-group">
                                    ...
                                    <label>Nama Peternak</label>
                                        <input class="form-control" value="Rudi" type="text" readonly>
                                </div>
                                    <div class="form-group">
                                    <label>Nama Pakan</label>
                                        <input class="form-control" value="Konsentrat Rumput Gajah" type="text" readonly>
                                    </div>
                                </div>
                            
                                <div class="form-group">
                                    <label>Bahan Baku</label>
                                    <input class="form-control" value="Rumput Gajah" type="text" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Jumlah (kg)</label>
                                    <input class="form-control" value="20kg" type="text" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Produksi</label>
                                    <input class="form-control" value="20/10/2018" type="text" readonly>
                                </div>

                                <hr>
                                <a href="/ubahDetail" class="btn btn-primary" type="submit">Ubah</a>
                            </form>
                        </div>
                    </div>
                </div>
