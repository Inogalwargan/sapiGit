                ...
                <div class="block form-block mb-4">
                    ...
                    <form action="#">
                        ...
                        <div class="form-group">
                            <label>Banyak Kebutuhan (Kg)</label>
                            <input class="form-control" placeholder="Banyak Kebutuhan" type="number" min="0">
                        </div>
                        <div class="form-group">
                            <label>Harga (Rp.)</label>
                            <input class="form-control" placeholder="Harga Pembelian" type="number" min="0">
                        </div>
